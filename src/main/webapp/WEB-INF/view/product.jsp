...
<c:if test="${list != null}">
	...
	<p>
		<a href="/product?load" class="btn btn-primary">Novo</a>
	</p>
...
<c:if test="${item != null}">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
				Produto <small>Detalhes do produto</small>
			</h1>
		</div>
	</div>
	<!-- /.row -->

	<form method="POST" action="/product?save" class="form-horizontal">
		<input type="hidden" name="old" value="${item.code}">
		...
		<div class="form-group">
			<label for="subtitle" class="col-md-2 control-label">Subtítulo</label>
			<div class="col-md-10">
